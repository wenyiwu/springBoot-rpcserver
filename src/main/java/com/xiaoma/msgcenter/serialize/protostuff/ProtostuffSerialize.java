 ...
 */
package com.xiaoma.msgcenter.serialize.protostuff;
...
import com.xiaoma.msgcenter.serialize.RpcSerialize;
...
public class ProtostuffSerialize implements RpcSerialize {
    ...
    public Object deserialize(InputStream input) {
        try {
            Class cls = isRpcDirect() ? MethodRequest.class : MethodResponse.class;
